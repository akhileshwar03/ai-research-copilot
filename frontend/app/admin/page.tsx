...
const SETTING_LABELS: Record<string, string> = {
  ...
  rag_full_document_max_chars: "Whole-document context budget for \"how many/list all\" questions (chars)",
  vision_ingestion_max_pages: "Max pages vision-captioned per upload (diagrams/charts become searchable; 0 = off)",
  ...
  documents_rate_limit_per_minute: "Document list/status/delete/pin rate limit (requests/min per IP)",
