  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--app-bg)] px-4">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 h-80 w-[500px] -translate-x-1/2 rounded-full bg-[var(--accent-glow)] opacity-20 blur-3xl" />
      </div>

      <div className="relative text-center">
        {/* Icon */}
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[var(--surface-2)] ring-1 ring-[var(--border-medium)]">
        ...
        {/* Giant number */}
        <p className="text-[80px] font-bold leading-none text-[var(--text-primary)] opacity-[0.06] select-none">404</p>

        <h1 className="font-headline mt-1 text-[18px] font-semibold text-[var(--text-primary)]">Page not found</h1>
