...
@router.post("/url", response_model=ExtractedText, dependencies=[require_tool("extract")])
...
@router.post("/image", response_model=ExtractedText, dependencies=[require_tool("extract")])
@limiter.limit(extract_rate_limit)
